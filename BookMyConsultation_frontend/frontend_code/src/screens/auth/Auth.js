...
const Auth = (props) => {                                       // for authentication
	...
	return (
		<AppModal isOpen={props.modalIsOpen} onRequestClose={props.onModalClose} title="Authentication">

			<TabContainer value={indexValue} valueHandler={indexValueHandler} tabNames={["Login", "Register"]} variant="scrollable"/>
